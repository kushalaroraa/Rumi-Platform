...
export const RoomFormModal = ({
  ...
  if (!open) return null;
  return <div className={variant === 'modal' ? 'fixed inset-0 z-[200] bg-black/50 flex items-center justify-center p-4' : 'fixed inset-0 z-[200] bg-gray-100 overflow-auto p-4 sm:p-8 flex items-start justify-center'}>
      <div className={variant === 'modal' ? 'w-full max-w-3xl bg-white rounded-3xl shadow-xl overflow-hidden' : 'w-full max-w-3xl bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100'}>
        ...
        <div className="p-6 max-h-[80vh] overflow-auto">
          {existingCover && mode === 'edit' && <div className="mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={propertyType} onChange={e => setPropertyType(e.target.value)}>
            ...
            <div>
              ...
              <select className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={roomType} onChange={e => setRoomType(e.target.value)}>
            ...
            <div>
              ...
              <input className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={city} onChange={e => setCity(e.target.value)} placeholder="e.g. Mumbai" />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Area</label>
              <input className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={area} onChange={e => setArea(e.target.value)} placeholder="e.g. Andheri West" />
            </div>

            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-2">Address (optional)</label>
              <input className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={address} onChange={e => setAddress(e.target.value)} placeholder="Landmark / building name" />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Monthly Rent (₹)</label>
              <input type="number" min={0} className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={monthlyRent} onChange={e => setMonthlyRent(Number(e.target.value))} />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Security Deposit (₹)</label>
              <input type="number" min={0} className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={securityDeposit} onChange={e => setSecurityDeposit(Number(e.target.value))} />
            </div>

            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-2">Furnishing</label>
              <select className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={furnishingStatus} onChange={e => setFurnishingStatus(e.target.value)}>
            ...
            <div>
              ...
              <input type="number" min={0} className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={bedAvailability} onChange={e => setBedAvailability(e.target.value === '' ? '' : Number(e.target.value))} placeholder="e.g. 1" />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Preferred Gender</label>
              <select className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={preferredGender} onChange={e => setPreferredGender(e.target.value)}>
            ...
            <div>
              ...
              <input type="number" min={0} className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={ageMin} onChange={e => setAgeMin(e.target.value === '' ? '' : Number(e.target.value))} placeholder="e.g. 20" />
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Age Max</label>
              <input type="number" min={0} className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={ageMax} onChange={e => setAgeMax(e.target.value === '' ? '' : Number(e.target.value))} placeholder="e.g. 30" />
            </div>

            <div className="md:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-2">Occupation Preference</label>
              <select className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={occupation} onChange={e => setOccupation(e.target.value)}>
                <option value="">No preference</option>
            ...
            <div className="md:col-span-2 flex flex-wrap gap-3">
              <div className="w-full md:w-[calc(50%-6px)]">
                ...
                <select className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={smokingAllowed} onChange={e => setSmokingAllowed(e.target.value)}>
                  <option value="">No preference</option>
              ...
              <div className="w-full md:w-[calc(50%-6px)]">
                ...
                <select className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={drinkingAllowed} onChange={e => setDrinkingAllowed(e.target.value)}>
                  <option value="">No preference</option>
                  <option value="allowed">Allowed</option>
                  <option value="not_allowed">Not allowed</option>
                </select>
              ...
              <div className="w-full md:w-[calc(50%-6px)]">
                ...
                <select className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={petsAllowed} onChange={e => setPetsAllowed(e.target.value)}>
                  <option value="">No preference</option>
                  <option value="allowed">Allowed</option>
                  <option value="not_allowed">Not allowed</option>
                </select>
              ...
              <div className="w-full md:w-[calc(50%-6px)]">
                ...
                <select className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={foodPreference} onChange={e => setFoodPreference(e.target.value)}>
                  <option value="">No preference</option>
            ...
            <div className="md:col-span-2 flex flex-wrap gap-3">
              <div className="w-full md:w-[calc(50%-6px)]">
                ...
                <select className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={sleepSchedule} onChange={e => setSleepSchedule(e.target.value)}>
                  <option value="">No preference</option>
              ...
              <div className="w-full md:w-[calc(50%-6px)]">
                ...
                <select className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={cleanlinessLevel} onChange={e => setCleanlinessLevel(e.target.value)}>
                  <option value="">No preference</option>
              ...
              <div className="w-full">
                ...
                <input className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={socialLevel} onChange={e => setSocialLevel(e.target.value)} placeholder="e.g. Low-key / Social" />
              </div>
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea value={roomDescription} onChange={e => setRoomDescription(e.target.value)} rows={4} className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" placeholder="Describe the space, ideal roommate fit, and house rules." />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <input className="w-full px-4 py-3 bg-slate-50 border border-slate-100 rounded-xl" value={preferredContactTime} onChange={e => setPreferredContactTime(e.target.value)} placeholder="e.g. Weekdays evenings" />
            </div>
          </div>

          <div className="mt-6 flex gap-3">
            <button type="button" onClick={onClose} className="flex-1 py-3.5 px-4 bg-white text-gray-700 border border-gray-200 rounded-xl font-semibold hover:bg-gray-50 transition-all" disabled={submitting}>
              Cancel
            </button>
            <button type="button" onClick={handleSave} disabled={submitting} className="flex-1 py-3.5 px-4 bg-[#081A35] text-white rounded-xl font-semibold hover:bg-[#081A35]/90 transition-all shadow-lg shadow-blue-900/10 disabled:opacity-60 disabled:cursor-not-allowed">
