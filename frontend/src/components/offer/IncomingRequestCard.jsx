...
export const IncomingRequestCard = ({
  ...
  return <div className="border border-gray-100 rounded-2xl p-4 bg-white">
      ...
      <div className="mt-4 flex gap-2">
        <button type="button" onClick={onAccept} className="flex-1 px-3 py-2 bg-blue-600 text-white rounded-xl text-sm font-medium hover:bg-blue-700 transition-colors">
          Accept
        </button>
        <button type="button" onClick={onReject} className="flex-1 px-3 py-2 bg-gray-100 text-gray-700 rounded-xl text-sm font-medium hover:bg-gray-200 transition-colors">
          Reject
        </button>
      </div>
    </div>;
