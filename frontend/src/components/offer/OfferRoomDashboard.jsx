...
import { Bell, Edit, Home, MessageCircle, Plus, Search, Settings, LogOut, Users } from 'lucide-react';
  ...
  return <div className="min-h-screen bg-gray-100 flex">
      ...
      <aside className="w-64 bg-white shadow-sm flex flex-col">
        ...
        <nav className="flex-1 px-4 py-2">
          ...
          <button onClick={() => setActiveNav('listings')} className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl mb-2 transition-colors ${activeNav === 'listings' ? 'bg-blue-600 text-white' : 'text-gray-600 hover:bg-gray-50'}`}>
          ...
          <button onClick={() => setActiveNav('requests')} className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl mb-2 transition-colors ${activeNav === 'requests' ? 'bg-blue-600 text-white' : 'text-gray-600 hover:bg-gray-50'}`}>
            <Users size={20} />
            <span>Requests</span>
          </button>
