...
export const SuggestedMatchCard = ({
  suggestion,
  onInvite
}) => {
  ...
  return <div className="border border-gray-100 rounded-2xl p-4 bg-white">
      <div className="flex items-start gap-3">
        <img src={avatar || 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop'} alt={suggestion?.name || 'User'} className="w-12 h-12 rounded-full object-cover bg-slate-100" />
      ...
      <div className="mt-4">
        <button type="button" onClick={onInvite} className="w-full px-3 py-2 bg-blue-600 text-white rounded-xl text-sm font-medium hover:bg-blue-700 transition-colors">
          Invite to Connect
        </button>
      </div>
    </div>;
