...
const Navbar = ({
  ...
  return <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center pt-6 px-4">
      ...
      {/* Mobile Menu */}
      {isOpen && <div className="absolute top-20 left-4 right-4 bg-white rounded-2xl p-6 shadow-xl flex flex-col gap-4 md:hidden z-50">
...
const SwipeCard = ({
  ...
  return <motion.div drag={isTop ? "x" : false} dragConstraints={{
    left: 0,
    right: 0
  }} onDragStart={() => setIsDragging(true)} onDragEnd={(e, info) => {
    setIsDragging(false);
    ...
    stiffness: 300,
    damping: 30
  }} className="absolute inset-4 bg-white rounded-3xl shadow-xl overflow-hidden cursor-grab active:cursor-grabbing" style={{
    zIndex: isTop ? 10 : 1
  }}>
      {/* Profile Image */}
      <div className="relative h-[65%] overflow-hidden">
        ...
        {/* Swipe Indicators */}
        {isDragging && <>
            <motion.div className="absolute top-8 left-8 bg-red-500 text-white px-6 py-3 rounded-2xl font-bold text-lg transform -rotate-12 border-4 border-white shadow-xl" animate={{
          opacity: exitX < -50 ? 1 : 0
        }}>
              NOPE
            </motion.div>
            <motion.div className="absolute top-8 right-8 bg-green-500 text-white px-6 py-3 rounded-2xl font-bold text-lg transform rotate-12 border-4 border-white shadow-xl" animate={{
          opacity: exitX > 50 ? 1 : 0
        }}>
              LIKE
            </motion.div>
      ...
      <div className="p-5 h-[35%] flex flex-col">
        ...
        <div className="flex flex-wrap gap-2 mb-auto">
          {profile.tags.map((tag, index) => <span key={index} className="px-3 py-1 bg-slate-100 text-slate-700 text-xs rounded-full font-medium">
              {tag}
            </span>)}
        </div>
...
const PhoneScreen = () => {
  ...
  return <div className="bg-slate-50 h-full w-full rounded-[2.5rem] overflow-hidden flex flex-col relative font-sans">
      {/* Notch Area */}
      ...
      <div className="flex-1 relative bg-slate-50">
        {currentIndex < profiles.length ? <>
            ...
            {currentIndex + 1 < profiles.length && <SwipeCard profile={profiles[currentIndex + 1]} onSwipe={handleSwipe} isTop={false} triggerSwipe={null} />}
...
const ProblemStatementSection = () => {
  ...
  return <section className="w-full py-24 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
             ...
             <div className="space-y-6">
              ...
              delay: 0.2
                ...
                <div className="flex flex-wrap gap-3">
                   {["Quiet & Clean Flatmate", "Early Riser Roommate", "Budget Friendly Flatmate"].map((tag, i) => <motion.span key={i} initial={{
                opacity: 0,
                y: 10
              }} whileInView={{
                opacity: 1,
...
const HowItWorksSection = () => {
  ...
  return <section className="w-full py-24 bg-white relative overflow-hidden border-t border-slate-50">
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-16">
           <motion.h2 initial={{
          opacity: 0,
          ...
          delay: 0.2
             ...
             <motion.div className="absolute top-1.5 bottom-1.5 rounded-full bg-gradient-to-r from-[#081A35] to-[#4E668A] shadow-md z-0" layout transition={{
            type: "spring",
            stiffness: 300,
            damping: 30
          }} style={{
            ...
            x: activeTab === 'find' ? '3px' : '0'
             ...
             <button onClick={() => setActiveTab('offer')} className={`relative z-10 px-8 py-2.5 rounded-full text-sm font-semibold transition-colors duration-200 ${activeTab === 'offer' ? 'text-white' : 'text-slate-500 hover:text-slate-700'}`}>
               Offer a Room
             </button>
             <button onClick={() => setActiveTab('find')} className={`relative z-10 px-8 py-2.5 rounded-full text-sm font-semibold transition-colors duration-200 ${activeTab === 'find' ? 'text-white' : 'text-slate-500 hover:text-slate-700'}`}>
               Find a Room
             </button>
           </motion.div>
        </div>
        ...
        <div className="relative min-h-[300px]">
          <AnimatePresence mode="wait">
            ...
            duration: 0.4
              ...
              {content[activeTab].map((step, index) => <div key={index} className="flex flex-col items-center text-center group">
                  ...
                  {index < 2 && <div className="hidden md:block absolute top-[2.5rem] left-[calc(16.666%+5rem)] w-[calc(33.333%-10rem)] h-px bg-slate-100 -z-10">
...
const TestimonialsSection = () => {
  ...
  return <section className="w-full py-24 bg-slate-50 relative overflow-hidden">
      <div className="container mx-auto px-4 max-w-6xl">
        {/* Section Header */}
        <div className="text-center mb-16">
          <motion.div initial={{
...
const TrustSafetySection = () => {
  ...
  return <section className="w-full py-24 bg-white relative overflow-hidden border-t border-slate-100">
      <div className="container mx-auto px-4 max-w-6xl">
        {/* Section Header */}
        <div className="text-center mb-16">
          <motion.div initial={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {safetyFeatures.map((feature, index) => <motion.div key={index} initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([{
    id: 1,
    text: "Hi! I'm Rumi's AI assistant. How can I help you find your perfect flatmate today?",
    sender: 'bot'
  }]);
  ...
  const sendUserMessage = async text => {
    ...
    try {
      ...
      setMessages(prev => [...prev.filter(m => m.id !== typingMessageId), {
        id: typingMessageId,
        text: isNetwork
          ? 'Cannot reach the server. Start the backend (cd backend && npm run dev) and ensure it runs on the same port as VITE_API_URL / your API proxy (default 9090).'
  ...
  return <>
      ...
      <AnimatePresence>
        ...
        duration: 0.2
            ...
            duration: 0.3
                  ...
                  {message.sender === 'bot' && <div className="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center mr-2 shrink-0">
            ...
            <div className="px-4 py-2 bg-white border-t border-slate-100">
              <div className="flex gap-2 overflow-x-auto pb-2">
                <button type="button" disabled={isAssistantTyping} onClick={() => sendUserMessage("How does matching work?")} className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-full text-xs font-medium whitespace-nowrap transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                  How does matching work?
                </button>
                <button type="button" disabled={isAssistantTyping} onClick={() => sendUserMessage("Pricing")} className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-full text-xs font-medium whitespace-nowrap transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                  Pricing
                </button>
                <button type="button" disabled={isAssistantTyping} onClick={() => sendUserMessage("Safety tips")} className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-full text-xs font-medium whitespace-nowrap transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                  Safety tips
                </button>
              </div>
            </div>
      ...
      type: "spring",
      stiffness: 200
    }} onClick={() => setIsOpen(!isOpen)} className="fixed bottom-6 right-4 md:right-8 z-50 w-16 h-16 bg-gradient-to-r from-[#081A35] to-[#4E668A] hover:from-[#0a1f40] hover:to-[#5a7498] text-white rounded-full shadow-2xl flex items-center justify-center transition-all hover:scale-110 group">
        <AnimatePresence mode="wait">
...
const Footer = () => {
  ...
  return <footer className="w-full bg-white relative overflow-hidden">
      {/* CTA Section */}
      <div className="w-full py-20 px-4 relative">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          duration: 0.5,
          delay: 0.2
        }} onSubmit={handleSubscribe} className="flex flex-col sm:flex-row items-center justify-center gap-3 max-w-md mx-auto">
...
export default function MainApp({ forceDashboard = false } = {}) {
  ...
  useEffect(() => {
    ...
    const run = async () => {
      try {
        ...
        if (forceDashboard && localStorage.getItem('rumi_token')) {
          setCurrentView('dashboard');
          return;
        }
  ...
  if (currentView === 'dashboard') {
    return <div className="w-full font-sans selection:bg-blue-200">
        <FontStyles />
        <Dashboard userEmail={signupEmail} onEditProfile={() => {
  ...
  if (currentView === 'signup') {
    return <div className="w-full font-sans selection:bg-blue-200">
        <FontStyles />
        <SignupScreen onNext={email => {
        setSignupEmail(email);
        setCurrentView('dashboard');
      }} onLogin={() => setCurrentView('landing')} initialEmail={signupEmail} />
      </div>;
  }
  if (currentView === 'otp') {
    return <div className="w-full font-sans selection:bg-blue-200">
        <FontStyles />
        <OTPScreen email={signupEmail} onVerify={code => setCurrentView('success')} onBack={() => setCurrentView('signup')} />
      </div>;
  }
  ...
  if (currentView === 'profile') {
    return <div className="w-full font-sans selection:bg-blue-200">
        <FontStyles />
        <ProfileSetupFlow mode={profileFlowMode} onComplete={() => setCurrentView(profileFlowMode === 'edit' ? 'dashboard' : 'confirmation')} />
      </div>;
  }
  if (currentView === 'confirmation') {
    return <div className="w-full font-sans selection:bg-blue-200">
        <FontStyles />
        <FinalConfirmationScreen onDashboard={() => setCurrentView('dashboard')} />
      </div>;
  }
  if (currentView === 'signin') {
    return <div className="w-full font-sans selection:bg-blue-200">
        <FontStyles />
        <SignInScreen onLoginSuccess={email => {
        setSignupEmail(email);
        setCurrentView('dashboard');
      }} onForgotPassword={() => setCurrentView('forgot-password')} onSignup={() => setCurrentView('signup')} />
      </div>;
  }
  if (currentView === 'forgot-password') {
    return <div className="w-full font-sans selection:bg-blue-200">
        <FontStyles />
        <ForgotPasswordFlow onBack={() => setCurrentView('signin')} onComplete={() => setCurrentView('signin')} />
      </div>;
  }
  return <div className="w-full font-sans selection:bg-blue-200">
      <FontStyles />
      ...
      <section className="min-h-screen w-full relative overflow-hidden flex flex-col items-center">
        ...
        <main className="relative z-10 container mx-auto px-4 pt-32 pb-20 flex flex-col items-center">
          ...
          <div className="relative w-full max-w-5xl mx-auto h-[600px] flex justify-center items-center mt-8">
            ...
            delay: 0.4,
            type: "spring"
          }} className="relative z-30 w-[300px] md:w-[320px] h-[640px] bg-slate-900 rounded-[3rem] p-3 shadow-2xl border-4 border-slate-800" style={{
